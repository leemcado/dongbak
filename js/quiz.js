...
else if(t==='4지선다삽화'){box(480,76,880,104,26,'q');
/* 삽화는 왼쪽, 선지는 오른쪽에 세로로. 가운데에 두면 문제·선지와 겹친다. */
box(268,342,404,332,30,'illust');
for(var i=0;i<4;i++)box(722,196+i*96,412,80,26,'o',i);}
